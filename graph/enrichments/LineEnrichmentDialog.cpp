...
LineEnrichmentDialog::LineEnrichmentDialog( LineEnrichment *line, QWidget* parent, Qt::WFlags fl )
    : QDialog( parent, fl )
{
...
void LineEnrichmentDialog::initGeometryTab()
{
...
void LineEnrichmentDialog::displayCoordinates(int unit)
{
...
void LineEnrichmentDialog::setCoordinates(int unit)
{
if (unit == ScaleCoordinates)
	{
...
void LineEnrichmentDialog::apply()
{
...
void LineEnrichmentDialog::accept()
{
apply();
close();
}

void LineEnrichmentDialog::setLineStyle(Qt::PenStyle style)
{
...
void LineEnrichmentDialog::enableHeadTab()
{
...
void LineEnrichmentDialog::pickColor()
{
...
void LineEnrichmentDialog::setDefaultValues()
{
...
void LineEnrichmentDialog::enableButtonDefault(QWidget *w)
{
if (w == geometry)
