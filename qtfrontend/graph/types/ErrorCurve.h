 ...
 *                                                                         *
 ***************************************************************************/
#ifndef ERROR_CURVE_H
#define ERROR_CURVE_H

#include "../PlotCurve.h"

//! Error bars curve
class ErrorCurve: public DataCurve
{
public:
	enum Orientation{Horizontal = 0, Vertical = 1};

	ErrorCurve(int orientation, Table *t, const char *name);
	ErrorCurve(Table *t, const char *name);

	void copy(const ErrorCurve *e);
