 ...
 *                                                                         *
 ***************************************************************************/
#ifndef HISTOGRAM_CURVE_H
#define HISTOGRAM_CURVE_H

#include "BarCurve.h"

//! Histogram class
class HistogramCurve: public BarCurve
{
public:
	HistogramCurve(Table *t, const QString& xColName, const char *name, int startRow, int endRow);
...
#endif // ifndef HISTOGRAM_CURVE_H
