...
class Plot3DDialog : public QDialog {
 ...
 public slots:
  ...
  void setColors(const QColor& title, const QColor& mesh, const QColor& axes,
 ...
 private:
  ...
  QColor titleColor, meshColor, bgColor, axesColor, numColor, labelColor,
      gridColor;
