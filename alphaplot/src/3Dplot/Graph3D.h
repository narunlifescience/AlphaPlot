 ...
 * inherit from MyWidget any more.
...
class Graph3D : public MyWidget {
 ...
 public:
  Graph3D(const QString& label, QWidget* parent = nullptr, const char* name = 0,
          Qt::WindowFlags f = 0);
  ~Graph3D();
 ...
 public slots:
  ...
  void initPlot();
  void initCoord();
  void addFunction(const QString& s, double xl, double xr, double yl, double yr,
                   double zl, double zr);
  ...
  void addData(Table* table, int xCol, int yCol, int zCol, double xl, double xr,
  ...
  void updateScales(double xl, double xr, double yl, double yr, double zl,
                    double zr, int xCol, int yCol, int zCol);
  ...
  void updateColors(const QColor& meshColor, const QColor& axesColor,
  ...
  void setColors(const QColor& meshColor, const QColor& axesColor,
                 const QColor& numColor, const QColor& labelColor,
                 const QColor& bgColor, const QColor& gridColor);
  //@}
