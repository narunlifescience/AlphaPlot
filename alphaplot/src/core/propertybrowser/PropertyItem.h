...
class PropertyItem : public QObject {
 ...
 public:
  enum class Property {
    ...
    // Plot3D Theme
    Plot3DTheme_Base_Separator,
    Plot3DTheme_Canvas_Background_Color,
    Plot3DTheme_Canvas_Font,
    Plot3DTheme_Graph_Separator,
    Plot3DTheme_Graph_Background_Visible,
    Plot3DTheme_Graph_Background_Color,
    Plot3DTheme_Light_Separator,
    Plot3DTheme_Light_Strength,
    Plot3DTheme_AmbientLight_Strength,
    Plot3DTheme_Light_Color,
    Plot3DTheme_Grid_Separator,
    Plot3DTheme_Grid_Visible,
    Plot3DTheme_Grid_Color,
    Plot3DTheme_Label_Separator,
    Plot3DTheme_Label_Background_Visible,
    Plot3DTheme_Label_Background_Color,
    Plot3DTheme_Label_Border_Visible,
    Plot3DTheme_Label_Color,
    // Plot3D Val Axis Value
    Plot3DAxisVal_Base_Separator,
    Plot3DAxisVal_AutoRange,
    Plot3DAxisVal_From,
    Plot3DAxisVal_To,
    Plot3DAxisVal_Inverted,
    Plot3DAxisVal_Tick_Separator,
    Plot3DAxisVal_Tick_Count,
    Plot3DAxisVal_SubTick_Count,
    Plot3DAxisVal_TickLabel_Format,
    Plot3DAxisVal_TickLabel_Rotation,
    Plot3DAxisVal_Label_Separator,
    Plot3DAxisVal_Label_Visible,
    Plot3DAxisVal_Label_Fixed,
    Plot3DAxisVal_Label_Text,
    // Plot3D Cat Axis Value
    Plot3DAxisCat_Base_Separator,
    Plot3DAxisCat_AutoRange,
    Plot3DAxisCat_From,
    Plot3DAxisCat_To,
    Plot3DAxisCat_Inverted,
    Plot3DAxisCat_TickLabel_Rotation,
    Plot3DAxisCat_Label_Separator,
    Plot3DAxisCat_Label_Visible,
    Plot3DAxisCat_Label_Fixed,
    Plot3DAxisCat_Label_Text,
  };
