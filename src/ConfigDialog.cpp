...
void ConfigDialog::initPlotsPage()
{
    ...
    connect(buttonNumbersFont, SIGNAL(clicked()), this,
            SLOT(pickNumbersFont()));
...
void ConfigDialog::initAppPage()
{
    ...
    connect(btnPanelsText, SIGNAL(clicked()), this,
            SLOT(pickPanelsTextColor()));
...
void ConfigDialog::languageChange()
{
    ...
    appTabWidget->setTabText(appTabWidget->indexOf(application),
                             tr("Application"));
    appTabWidget->setTabText(appTabWidget->indexOf(confirm),
                             tr("Confirmations"));
...
void ConfigDialog::apply()
{
    ...
    if (currentBoxIndex > -1) {
        app_->d_default_numeric_format =
                boxDefaultNumericFormat->itemData(currentBoxIndex)
                        .toChar()
                        .toLatin1();
    }
