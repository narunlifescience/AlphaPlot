    ...
    : QWidget(graph->plotWidget()->canvas()), PlotToolInterface(graph)
{
    ...
    d_average_pixels =
            (average_pixels % 2) ? average_pixels : average_pixels + 1;
                                           ...
                                           const QPoint &end)
{
    ...
    Column *pixelCol = new Column(tr("pixel"), AlphaPlot::Numeric);
    Column *xCol = new Column(tr("x"), AlphaPlot::Numeric);
    Column *yCol = new Column(tr("y"), AlphaPlot::Numeric);
    Column *intCol = new Column(tr("intensity"), AlphaPlot::Numeric);
    pixelCol->setPlotDesignation(AlphaPlot::X);
    xCol->setPlotDesignation(AlphaPlot::Y);
    yCol->setPlotDesignation(AlphaPlot::Y);
    intCol->setPlotDesignation(AlphaPlot::Y);
