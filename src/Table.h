...
public slots:
    ...
    // TODO: If one of the indices or the cell content is invalid, return 0.0.
    // For the next non-bugfix AlphaPlot release, indication of failure should
    // be done by returning NaN (wherever applicable).
