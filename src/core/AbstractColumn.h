...
public:
    ...
    virtual AlphaPlot::ColumnDataType dataType() const = 0;
     ...
     */
    virtual AlphaPlot::ColumnMode columnMode() const = 0;
    //! Set the column mode
    /**
    ...
    // Q_UNUSED(i) Q_UNUSED(invalid) };
    //! Overloaded function for convenience
    // virtual void setInvalid(int row, bool invalid = true) { Q_UNUSED(row)
    // Q_UNUSED(invalid) };
     ...
     */
    // virtual void setMasked(Interval<int> i, bool mask = true) { Q_UNUSED(i)
    // Q_UNUSED(mask) };
    //! Overloaded function for convenience
    // virtual void setMasked(int row, bool mask = true) { Q_UNUSED(row)
    // Q_UNUSED(mask) };
    //@}
    ...
    // virtual void setFormula(Interval<int> i, QString formula) { Q_UNUSED(i)
    // Q_UNUSED(formula) };
    //! Overloaded function for convenience
    // virtual void setFormula(int row, QString formula) { Q_UNUSED(row)
    // Q_UNUSED(formula) };
    //! Clear all formulas
     ...
     * Use this only when dataType() is QString
     */
    // virtual void setTextAt(int row, const QString& new_value) { Q_UNUSED(row)
    // Q_UNUSED(new_value) };
     ...
     * Use this only when dataType() is QDateTime
     */
    // virtual void setDateAt(int row, const QDate& new_value) { Q_UNUSED(row)
    // Q_UNUSED(new_value) };
     ...
     * Use this only when dataType() is QDateTime
     */
    // virtual void setTimeAt(int row, const QTime& new_value) { Q_UNUSED(row)
    // Q_UNUSED(new_value) };
     ...
     * Use this only when dataType() is double
     */
    // virtual void setValueAt(int row, double new_value) { Q_UNUSED(row)
    // Q_UNUSED(new_value) };
    //! Replace a range of values
    /**
     * Use this only when dataType() is double
...
signals:
     ...
     * one handler for lots of columns.
     */
    void aboutToBeReplaced(const AbstractColumn *source,
     ...
     */
    void rowsAboutToBeInserted(const AbstractColumn *source, int before,
                               int count);
     ...
     */
    void rowsAboutToBeRemoved(const AbstractColumn *source, int first,
                              int count);
