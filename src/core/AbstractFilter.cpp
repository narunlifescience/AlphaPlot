...
bool AbstractFilter::input(int port, const AbstractColumn *source)
{
    ...
    if (source) { // we have a new source
        ...
        QObject::connect(
                ...
                this,
                SLOT(inputDescriptionAboutToChange(const AbstractAspect *)));
        QObject::connect(
                source,
        ...
        QObject::connect(
                source,
                SIGNAL(plotDesignationAboutToChange(const AbstractColumn *)),
                this,
                SLOT(inputPlotDesignationAboutToChange(
                        const AbstractColumn *)));
        QObject::connect(
                source, SIGNAL(plotDesignationChanged(const AbstractColumn *)),
                this,
                SLOT(inputPlotDesignationChanged(const AbstractColumn *)));
        QObject::connect(
                source, SIGNAL(modeAboutToChange(const AbstractColumn *)), this,
        ...
        QObject::connect(
                source, SIGNAL(dataAboutToChange(const AbstractColumn *)), this,
        ...
        QObject::connect(
                ...
                this,
                SLOT(inputRowsAboutToBeInserted(const AbstractColumn *, int,
                                                int)));
        QObject::connect(
                source, SIGNAL(rowsInserted(const AbstractColumn *, int, int)),
                this,
        ...
        QObject::connect(
                ...
                this,
                SLOT(inputRowsAboutToBeRemoved(const AbstractColumn *, int,
                                               int)));
        QObject::connect(
                source, SIGNAL(rowsRemoved(const AbstractColumn *, int, int)),
                this, SLOT(inputRowsRemoved(const AbstractColumn *, int, int)));
        QObject::connect(
                source, SIGNAL(maskingAboutToChange(const AbstractColumn *)),
        ...
        QObject::connect(
                source, SIGNAL(aboutToBeDestroyed(const AbstractColumn *)),
