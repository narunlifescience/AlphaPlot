...
/**
 * AlphaPlot's Parts are somewhat similar to KDE's KParts in that they are
...
public:
    ...
    AbstractPart(const QString &name)
        : AbstractAspect(name), d_mdi_window(0) { }
    //! Construct a primary view on me.
    /**
     * The caller recieves ownership of the view.
     *
     * This method may be called multiple times during the life time of a Part,
     * or it might not get called at all. Parts must not depend on the existence
     * of a view for their operation.
     */
