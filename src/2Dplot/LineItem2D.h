...
public:
    ...
    getendstyle_lineitem(const LineEndLocation &location) const;
    ...
    QString
    getendstylestring_lineitem(const QCPLineEnding::EndingStyle endstyle) const;
    QCPLineEnding::EndingStyle
    getendstyleenum_lineitem(const QString end) const;
