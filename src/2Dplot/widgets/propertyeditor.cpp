      ...
      fontFactory_(new QtFontEditorFactory(propertybrowser_))
{
    ...
    propertybrowser_->setFactoryForManager(doubleManager_,
                                           doubleSpinBoxFactory_);
    propertybrowser_->setFactoryForManager(stringManager_, lineEditFactory_);
    propertybrowser_->setFactoryForManager(
            sizeManager_->subIntPropertyManager(), spinBoxFactory_);
    propertybrowser_->setFactoryForManager(
            rectManager_->subIntPropertyManager(), spinBoxFactory_);
    ...
    enumManager_->setEnumIcons(axispropertystroketypeitem_,
                               stroketypeiconslist);
    ...
    enumManager_->setEnumNames(axispropertyticklabelsideitem_,
                               axislabelsidelist);
    ...
    itempropertytextrotationitem_ =
            doubleManager_->addProperty("Text Rotation");
    itempropertytextpositionalignmentitem_ =
            enumManager_->addProperty("Positional alignment");
    enumManager_->setEnumNames(itempropertytextpositionalignmentitem_,
                               alignlist);
    ...
    itempropertylineendingstyleitem_ =
            enumManager_->addProperty("Ending Style");
    enumManager_->setEnumNames(itempropertylineendingstyleitem_,
                               endingstylelist);
    ...
    itempropertyimagestroketypeitem_ =
            enumManager_->addProperty("Stroke Style");
    enumManager_->setEnumNames(itempropertyimagestroketypeitem_,
                               stroketypelist);
    ...
    enumManager_->setEnumNames(lsplotpropertylinestroketypeitem_,
                               stroketypelist);
    ...
    channel1plotpropertylinestyleitem_ =
            enumManager_->addProperty("Line Style");
    ...
    channel1plotpropertyscatterstyleitem_ =
            enumManager_->addProperty("Scatter Style");
    enumManager_->setEnumNames(channel1plotpropertyscatterstyleitem_,
                               sstylelist);
    channel1plotpropertygroupitem_->addSubProperty(
            channel1plotpropertyscatterstyleitem_);
    ...
    channel2plotpropertyscatterstyleitem_ =
            enumManager_->addProperty("Scatter Style");
    enumManager_->setEnumNames(channel2plotpropertyscatterstyleitem_,
                               sstylelist);
    channel2plotpropertygroupitem_->addSubProperty(
            channel2plotpropertyscatterstyleitem_);
    ...
    cplotpropertylinestroketypeitem_ =
            enumManager_->addProperty("Line Stroke Type");
    enumManager_->setEnumNames(cplotpropertylinestroketypeitem_,
                               stroketypelist);
    ...
    statboxplotpropertyfillstatusitem_ =
            boolManager_->addProperty("Fill Status");
    statboxplotpropertyfillcoloritem_ =
            colorManager_->addProperty("Fill Color");
    ...
    statboxplotpropertyscatterstyleitem_ =
            enumManager_->addProperty("Scatter Style");
    enumManager_->setEnumNames(statboxplotpropertyscatterstyleitem_,
                               sstylelist);
    ...
    vectorpropertylinestroketypeitem_ =
            enumManager_->addProperty("Line Stroke Type");
    enumManager_->setEnumNames(vectorpropertylinestroketypeitem_,
                               stroketypelist);
    ...
    colormappropertylevelcountitem_ =
            intManager_->addProperty(tr("Level Count"));
    ...
    colormappropertyscaleaxislinlogitem_ =
            enumManager_->addProperty(tr("Type"));
    colormappropertyscaleaxisvisibleitem_->addSubProperty(
            colormappropertyscaleaxislinlogitem_);
    ...
    plot3dcanvasgridvisibleitem_ =
            boolManager_->addProperty(tr("Grid Visible"));
    ...
    plot3daxiscatagorytitletextitem_ =
            stringManager_->addProperty("Label Text");
    ...
    plot3dsurfaceseriescolorstyleitem_ =
            enumManager_->addProperty("Color Style");
    ...
    plot3dbarseriesbasegradiantitem_ =
            enumManager_->addProperty("Gradient Color");
    enumManager_->setEnumNames(plot3dbarseriesbasegradiantitem_,
                               gradientlist3d);
    ...
    connect(this, &PropertyEditor::refreshCanvasRect, [=]() {
        ...
        if (item
            ...
            rectManager_->setValue(layoutpropertyrectitem_,
                                   axisrect->outerRect());
        }
    });
}
...
MyTreeWidget *PropertyEditor::getObjectBrowser()
{
    return objectbrowser_;
}
...
void PropertyEditor::myWidgetConnections(MyWidget *widget)
{
    connect(widget, &MyWidget::geometrychange, [=]() {
        if (objectbrowser_->currentItem()
            ...
            if (widget == mw) {
                rectManager_->setValue(mywidgetwindowrectitem_,
                                       widget->geometry());
            }
        }
    });
        ...
        if (objectbrowser_->currentItem()
            && static_cast<MyTreeWidget::PropertyItemType>(
                       objectbrowser_->currentItem()
                               ->data(0, Qt::UserRole)
                               .value<int>())
                    == MyTreeWidget::PropertyItemType::TableWindow) {
            Table *tab = getgraph2dobject<Table>(objectbrowser_->currentItem());
            if (table == tab) {
                intManager_->setValue(tablewindowrowcountitem_,
                                      table->numRows());
                intManager_->setValue(tablewindowcolcountitem_,
                                      table->numCols());
            }
        }
    });
...
void PropertyEditor::matrixConnections(Matrix *matrix)
{
    connect(matrix, &Matrix::modifiedWindow, [=]() {
        if (objectbrowser_->currentItem()
            ...
            Matrix *mat =
                    getgraph2dobject<Matrix>(objectbrowser_->currentItem());
            if (matrix == mat) {
                intManager_->setValue(matrixwindowrowcountitem_,
                                      matrix->numRows());
                intManager_->setValue(matrixwindowcolcountitem_,
                                      matrix->numCols());
            }
        }
    });
...
void PropertyEditor::valueChange(QtProperty *prop, const bool value)
{
    if (prop->compare(canvaspropertyopenglitem_)) {
        ...
        Curve2D *curve =
                getgraph2dobject<Curve2D>(objectbrowser_->currentItem());
        ...
        Q3DTheme *theme =
                getgraph2dobject<Q3DTheme>(objectbrowser_->currentItem());
        ...
        QCategory3DAxis *axis = getgraph2dobject<QCategory3DAxis>(
                objectbrowser_->currentItem());
        axis->setAutoAdjustRange(value);
        ...
        DataBlockSurface3D *block = getgraph2dobject<DataBlockSurface3D>(
                objectbrowser_->currentItem());
        ...
        DataBlockScatter3D *block = getgraph2dobject<DataBlockScatter3D>(
                objectbrowser_->currentItem());
        block->getdataseries()->setVisible(value);
...
void PropertyEditor::valueChange(QtProperty *prop, const double &value)
{
    if (prop->compare(canvaspropertybufferdevicepixelratioitem_)) {
        ...
        ColorMap2D *colormap =
                getgraph2dobject<ColorMap2D>(objectbrowser_->currentItem());
        colormap->getcolormapscale_colormap()->axis()->setTickLabelRotation(
                value);
        colormap->layer()->replot();
...
void PropertyEditor::valueChange(QtProperty *prop, const QString &value)
{
    if (prop->compare(mywidgetwindownameitem_)) {
        ...
        AxisRect2D *axisrect = getgraph2dobject<AxisRect2D>(
                objectbrowser_->currentItem()->parent());
...
void PropertyEditor::valueChange(QtProperty *prop, const int value)
{
    if (prop->compare(axispropertyoffsetitem_)) {
        ...
        ColorMap2D *colormap =
                getgraph2dobject<ColorMap2D>(objectbrowser_->currentItem());
        colormap->getcolormapscale_colormap()->axis()->setSubTickLengthIn(
                value);
        colormap->layer()->replot();
    } else if (prop->compare(colormappropertyscaleaxissubticklengthoutitem_)) {
        ColorMap2D *colormap =
                getgraph2dobject<ColorMap2D>(objectbrowser_->currentItem());
        colormap->getcolormapscale_colormap()->axis()->setSubTickLengthOut(
                value);
        colormap->layer()->replot();
    } else if (prop->compare(colormappropertyscaleaxisticklabelpaddingitem_)) {
        ColorMap2D *colormap =
                getgraph2dobject<ColorMap2D>(objectbrowser_->currentItem());
        colormap->getcolormapscale_colormap()->axis()->setTickLabelPadding(
                value);
        colormap->layer()->replot();
    } else if (prop->compare(colormappropertyscaleaxisticklabelpaddingitem_)) {
        ColorMap2D *colormap =
                getgraph2dobject<ColorMap2D>(objectbrowser_->currentItem());
        colormap->getcolormapscale_colormap()->axis()->setNumberPrecision(
                value);
        colormap->layer()->replot();
...
void PropertyEditor::enumValueChange(QtProperty *prop, const int value)
{
    if (prop->compare(hgridaxispropertycomboitem_)) {
        ...
        Legend2D *legend =
                getgraph2dobject<Legend2D>(objectbrowser_->currentItem());
        legend->setborderstrokestyle_legend(
                static_cast<Qt::PenStyle>(value + 1));
        legend->layer()->replot();
        ...
        ImageItem2D *imageitem =
                getgraph2dobject<ImageItem2D>(objectbrowser_->currentItem());
        imageitem->setstrokestyle_imageitem(
                static_cast<Qt::PenStyle>(value + 1));
        imageitem->layer()->replot();
        ...
        LineSpecial2D *lsgraph =
                getgraph2dobject<LineSpecial2D>(objectbrowser_->currentItem());
        lsgraph->setlinestrokestyle_lsplot(
                static_cast<Qt::PenStyle>(value + 1));
        lsgraph->layer()->replot();
        lsgraph->getxaxis()->getaxisrect_axis()->getLegend()->layer()->replot();
        ...
        LineSpecial2D *lsgraph =
                getgraph2dobject<LineSpecial2D>(objectbrowser_->currentItem());
        lsgraph->setscatterstrokestyle_lsplot(
                static_cast<Qt::PenStyle>(value + 1));
        lsgraph->layer()->replot();
        lsgraph->getxaxis()->getaxisrect_axis()->getLegend()->layer()->replot();
        ...
        Curve2D *curve =
                getgraph2dobject<Curve2D>(objectbrowser_->currentItem());
        curve->setscatterstrokestyle_cplot(
                static_cast<Qt::PenStyle>(value + 1));
        curve->layer()->replot();
        ...
        StatBox2D *statbox =
                getgraph2dobject<StatBox2D>(objectbrowser_->currentItem());
        statbox->setmedianstrokestyle_statbox(
                static_cast<Qt::PenStyle>(value + 1));
        statbox->layer()->replot();
        statbox->getxaxis()->getaxisrect_axis()->getLegend()->layer()->replot();
        ...
        Vector2D *vector =
                getgraph2dobject<Vector2D>(objectbrowser_->currentItem());
        vector->setlinestrokestyle_vecplot(
                static_cast<Qt::PenStyle>(value + 1));
        vector->layer()->replot();
        vector->getxaxis()->getaxisrect_axis()->getLegend()->layer()->replot();
        ...
        ColorMap2D *colormap =
                getgraph2dobject<ColorMap2D>(objectbrowser_->currentItem());
        colormap->setgradient_colormap(
                static_cast<ColorMap2D::Gradient>(value));
        colormap->layer()->replot();
        ...
        QAbstract3DGraph *graph = getgraph2dobject<QAbstract3DGraph>(
                objectbrowser_->currentItem());
...
void PropertyEditor::Axis2DPropertyBlock(Axis2D *axis)
{
    ...
    fontManager_->setValue(axispropertylabelfontitem_,
                           axis->getlabelfont_axis());
    ...
    intManager_->setValue(axispropertytickcountitem_,
                          axis->gettickscount_axis());
    doubleManager_->setValue(axispropertytickoriginitem_,
                             axis->getticksorigin());
...
void PropertyEditor::TextItem2DPropertyBlock(TextItem2D *textitem)
{
    ...
    doubleManager_->setValue(itempropertytextrotationitem_,
                             textitem->rotation());
...
void PropertyEditor::LineItem2DPropertyBlock(LineItem2D *lineitem)
{
    ...
    doubleManager_->setValue(itempropertylinestartinglengthitem_,
...
void PropertyEditor::Curve2DPropertyBlock(Curve2D *curve, AxisRect2D *axisrect)
{
    propertybrowser_->clear();
                                            ...
                                            AxisRect2D *axisrect)
{
...

    {
        ...
        enumManager_->setEnumNames(statboxplotpropertyyaxisitem_,
                                   statboxyaxislist);
...

    {
        ...
        enumManager_->setEnumNames(statboxplotpropertyxaxisitem_,
                                   statboxxaxislist);
                                             ...
                                             AxisRect2D *axisrect)
{
    ...
    enumManager_->setValue(
            colormappropertyscaleaxisstroketypeitem_,
            colormap->getcolormapscale_colormap()->axis()->basePen().style()
                    - 1);
    boolManager_->setValue(
            colormappropertyscaleaxisantialiaseditem_,
    ...
    enumManager_->setValue(
            colormappropertyscaleaxistickstroketypeitem_,
            colormap->getcolormapscale_colormap()->axis()->tickPen().style()
                    - 1);
    boolManager_->setValue(
            colormappropertyscaleaxissubtickvisibilityitem_,
    ...
    colorManager_->setValue(colormappropertyscaleaxissubtickstrokecoloritem_,
                            colormap->getcolormapscale_colormap()
                                    ->axis()
                                    ->subTickPen()
                                    .color());
    doubleManager_->setValue(
    ...
    enumManager_->setValue(
            colormappropertyscaleaxissubtickstroketypeitem_,
            colormap->getcolormapscale_colormap()->axis()->subTickPen().style()
                    - 1);
    boolManager_->setValue(
            colormappropertyscaleaxisticklabelvisibilityitem_,
...
void PropertyEditor::Canvas3DPropertyBlock(QAbstract3DGraph *graph)
{
    ...
    enumManager_->setValue(plot3dcanvasthemeitem_,
                           graph->activeTheme()->type());
...
void PropertyEditor::Theme3DPropertyBlock(Q3DTheme *theme)
{
    ...
    boolManager_->setValue(plot3dcanvasgridvisibleitem_,
                           theme->isGridEnabled());
...
void PropertyEditor::Axis3DValuePropertyBlock(QValue3DAxis *axis)
{
    ...
    boolManager_->setValue(plot3daxisvaluetitlevisibleitem_,
                           axis->isTitleVisible());
    boolManager_->setValue(plot3daxisvaluetitlefixeditem_,
                           axis->isTitleFixed());
...
void PropertyEditor::Bar3DPropertyBlock(Bar3D *bar)
{
    ...
    boolManager_->setValue(plot3dbarpolarstatusitem_,
                           bar->getGraph()->isPolar());
}
...
void PropertyEditor::populateObjectBrowser(MyWidget *widget)
{
    ...
    QString tooltiptextxyy =
            QString("<tr> <td align=\"right\">Table :</td><td>%1</td></tr>"
                    ...
                    "<tr> <td align=\"right\">From :</td><td>%6</td></tr>"
                    "<tr> <td align=\"right\">To :</td><td>%7</td></tr>");
    QString tooltiptextmatrix =
            QString("<tr> <td align=\"right\">Matrix :</td><td>%1</td></tr>"
    ...
    // window
    {
        ...
        QTreeWidgetItem *windowitem =
                new QTreeWidgetItem(static_cast<QTreeWidget *>(nullptr),
                                    QStringList(windowitemtext));
        windowitem->setToolTip(0, windowitemtext);
        windowitem->setIcon(0,
                            IconLoader::load("edit-table-dimension",
    ...
    if (qobject_cast<Layout2D *>(widget)) {
        ...
        objectbrowser_->setHeaderLabel(
                qobject_cast<Layout2D *>(widget)->name());
        objectbrowser_->headerItem()->setIcon(
        ...
        for (int i = 0; i < elementslist.size(); ++i) {
            ...
            for (int j = 0; j < xaxes.size(); j++) {
                ...
                case Axis2D::AxisOreantation::Bottom:
                    ...
                    axisitem->setIcon(0,
                                      IconLoader::load("graph2d-axis-bottom",
                                                       IconLoader::LightDark));
                    break;
                case Axis2D::AxisOreantation::Top:
                    axistext = QString("X Axis: " + QString::number(j + 1));
                    axisitem->setIcon(0,
                                      IconLoader::load("graph2d-axis-top",
                                                       IconLoader::LightDark));
                    break;
            ...
            for (int j = 0; j < yaxes.size(); j++) {
                ...
                case Axis2D::AxisOreantation::Left:
                    ...
                    axisitem->setIcon(0,
                                      IconLoader::load("graph2d-axis-left",
                                                       IconLoader::LightDark));
                    break;
                case Axis2D::AxisOreantation::Right:
                    axistext = QString("Y Axis: " + QString::number(j + 1));
                    axisitem->setIcon(0,
                                      IconLoader::load("graph2d-axis-right",
                                                       IconLoader::LightDark));
                    break;
                case Axis2D::AxisOreantation::Top:
                case Axis2D::AxisOreantation::Bottom:
            ...
            foreach (QCPLayer *layer, layervec) {
                ...
                for (int j = 0; j < textitems.size(); j++) {
                    if (layer == textitems.at(j)->layer()) {
                        QTreeWidgetItem *textitem = new QTreeWidgetItem(
                                static_cast<QTreeWidget *>(nullptr));
                        QString text =
                                QString("Text Item: " + QString::number(j + 1));
                        textitem->setIcon(
                                0,
                                IconLoader::load("draw-text",
                                                 IconLoader::LightDark));
                ...
                for (int j = 0; j < lineitems.size(); j++) {
                    if (layer == lineitems.at(j)->layer()) {
                        QTreeWidgetItem *lineitem = new QTreeWidgetItem(
                                static_cast<QTreeWidget *>(nullptr));
                        QString text =
                                QString("Line Item: " + QString::number(j + 1));
                        lineitem->setIcon(
                                0,
                                IconLoader::load("draw-line",
                                                 IconLoader::LightDark));
                ...
                for (int j = 0; j < imageitems.size(); j++) {
                    if (layer == imageitems.at(j)->layer()) {
                        QTreeWidgetItem *imageitem = new QTreeWidgetItem(
                                static_cast<QTreeWidget *>(nullptr));
                        QString text = QString("Image Item: "
                                               + QString::number(j + 1));
                        imageitem->setIcon(
                                0,
                                IconLoader::load("view-image",
                                                 IconLoader::LightDark));
                ...
                for (int j = 0; j < curvevec.size(); j++) {
                    if (layer == curvevec.at(j)->layer()) {
                        ...
                        case Graph2DCommon::PlotType::Function:
                            curvegraphtext =
                                    QString("Function %1").arg(function++);
                            curvegraphitem->setIcon(
                                    0,
                                    IconLoader::load("graph2d-function-xy",
                                                     IconLoader::LightDark));
                            curvegraphitem->setText(0, curvegraphtext);
                        ...
                        // x error
                        ErrorBar2D *xerror =
                                curvegraph->getxerrorbar_curveplot();
                        if (xerror) {
                            DataBlockError *data = xerror->getdatablock_error();
                            QString xerrortext = data->gettable()->name() + "_"
                                    + data->geterrorcolumn()->name() + "["
                        ...
                        // y error
                        ErrorBar2D *yerror =
                                curvegraph->getyerrorbar_curveplot();
                        if (yerror) {
                            DataBlockError *data = yerror->getdatablock_error();
                            QString yerrortext = data->gettable()->name() + "_"
                                    + data->geterrorcolumn()->name() + "["
                ...
                for (int j = 0; j < statboxvec.size(); j++) {
                    if (layer == statboxvec.at(j)->layer()) {
                        ...
                        QString statboxtext =
                                ...
                                + QString::number(statbox->getfrom_statbox()
                                                  + 1)
                                + ":"
                        ...
                        QTreeWidgetItem *statboxitem = new QTreeWidgetItem(
                                static_cast<QTreeWidget *>(nullptr),
                                QStringList(statboxtext));
                        QString tooltip =
                                tooltiptextx
                                        .arg(statbox->gettable_statbox()
                                                     ->name())
                                        .arg(statbox->getcolumn_statbox()
                                                     ->name())
                                        .arg(QString::number(
                                                statbox->getfrom_statbox() + 1))
                                        .arg(QString::number(
                                                statbox->getto_statbox() + 1));
                        statboxitem->setToolTip(0, tooltip);
                        statboxitem->setIcon(
                                0,
                                IconLoader::load("graph2d-box",
                                                 IconLoader::LightDark));
                        statboxitem->setData(
                                0, Qt::UserRole,
                                static_cast<int>(
                ...
                for (int j = 0; j < vectorvec.size(); j++) {
                    if (layer == vectorvec.at(j)->layer()) {
                        ...
                        QString vectortext = vector->gettable_vecplot()->name()
                                + "_" + vector->getfirstcol_vecplot()->name()
                                + "_" + vector->getsecondcol_vecplot()->name()
                                + "_" + vector->getthirdcol_vecplot()->name()
                                + "_" + vector->getfourthcol_vecplot()->name()
                                + "["
                        ...
                        QTreeWidgetItem *vectoritem = new QTreeWidgetItem(
                                static_cast<QTreeWidget *>(nullptr),
                                QStringList(vectortext));
                        QString tooltiptext =
                                tooltiptextxyyy
                                        .arg(vector->gettable_vecplot()->name())
                                        .arg(vector->getfirstcol_vecplot()
                                                     ->name())
                                        .arg(vector->getsecondcol_vecplot()
                                                     ->name())
                                        .arg(vector->getthirdcol_vecplot()
                                                     ->name())
                                        .arg(vector->getfourthcol_vecplot()
                                                     ->name())
                                        .arg(QString::number(
                                                vector->getfrom_vecplot() + 1))
                                        .arg(QString::number(
                                                vector->getto_vecplot() + 1));
                        vectoritem->setToolTip(0, tooltiptext);
                        vectoritem->setIcon(
                                0,
                                IconLoader::load("graph2d-vector-xy",
                                                 IconLoader::LightDark));
                        vectoritem->setData(
                                0, Qt::UserRole,
                                static_cast<int>(
                ...
                for (int j = 0; j < barvec.size(); j++) {
                    if (layer == barvec.at(j)->layer()) {
                        ...
                        if (bar->ishistogram_barplot()) {
                            bartext = bar->getdatablock_histplot()
                                              ->gettable()
                                              ->name()
                                    + "_"
                                    + bar->getdatablock_histplot()
                                              ->getcolumn()
                                              ->name()
                                    + "["
                                    + QString::number(
                            ...
                            if ((bar->getxaxis()->getorientation_axis()
                                ...
                                baritem->setIcon(
                                        0,
                                        IconLoader::load(
                                                "graph2d-vertical-bar",
                                                IconLoader::LightDark));
                            } else if ((bar->getxaxis()->getorientation_axis()
                                                == Axis2D::AxisOreantation::Top
                                        || bar->getxaxis()
                                                        ->getorientation_axis()
                                                == Axis2D::AxisOreantation::
                                                        Bottom)
                                       && bar->getstackposition_barplot()
                                               != -1) {
                                baritem->setIcon(
                                        0,
                                        IconLoader::load(
                                                "graph2d-vertical-stack-bar",
                                                IconLoader::LightDark));
                            } else if ((bar->getxaxis()->getorientation_axis()
                                                != Axis2D::AxisOreantation::Top
                                        && bar->getxaxis()
                                ...
                                baritem->setIcon(
                                        0,
                                        IconLoader::load(
                                                "graph2d-horizontal-bar",
                                                IconLoader::LightDark));
                            } else
                                baritem->setIcon(
                                        0,
                                        IconLoader::load(
                                                "graph2d-horizontal-stack-bar",
                                                IconLoader::LightDark));
                            QString tooltiptext =
                                    tooltiptextxy.arg(data->gettable()->name())
                                            .arg(data->getxcolumn()->name())
                ...
                for (int j = 0; j < pievec.size(); j++) {
                    if (layer == pievec.at(j)->layer()) {
                        ...
                        QString tooltip =
                                tooltiptextx
                                        .arg(pie->gettable_pieplot()->name())
                                        .arg(pie->getxcolumn_pieplot()->name())
                                        .arg(QString::number(
                                                pie->getfrom_pieplot() + 1))
                                        .arg(QString::number(
                                                pie->getto_pieplot() + 1));
                        pieitem->setToolTip(0, tooltip);
                        pieitem->setIcon(
                                0,
                                IconLoader::load("graph2d-pie",
                                                 IconLoader::LightDark));
                        pieitem->setData(
                                0, Qt::UserRole,
                                static_cast<int>(
                ...
                for (int j = 0; j < colormapvec.size(); j++) {
                    if (layer == colormapvec.at(j)->layer()) {
                        ...
                        QString colormaptext =
                                ...
                                + QString::number(colormap->getrows_colormap())
                                + "x"
                                + QString::number(
                                        colormap->getcolumns_colormap())
                                + "]";
                        QTreeWidgetItem *colormapitem = new QTreeWidgetItem(
                                static_cast<QTreeWidget *>(nullptr),
                                QStringList(colormaptext));
                        QString tooltip =
                                tooltiptextmatrix
                                        .arg(colormap->getmatrix_colormap()
                                                     ->name())
                                        .arg(QString::number(
                                                colormap->getrows_colormap()))
                                        .arg(QString::number(
                                                colormap->getcolumns_colormap()));
                        colormapitem->setToolTip(0, tooltip);
                        colormapitem->setIcon(
                                0,
                                IconLoader::load("edit-colormap3d",
                                                 IconLoader::General));
            ...
            griditem->setData(
                    0, Qt::UserRole,
                    static_cast<int>(
                            MyTreeWidget::PropertyItemType::Plot2DGrid));
        ...
        case Graph3DCommon::Plot3DType::Surface: {
            plot3dptvar =
                    QVariant::fromValue<void *>(lout->getSurface3DModifier());
        ...
        case Graph3DCommon::Plot3DType::Scatter: {
            plot3dptvar =
                    QVariant::fromValue<void *>(lout->getScatter3DModifier());
            axisxitemtext = QString("X Axis(val)");
            axisyitemtext = QString("Y Axis(val)");
            propertyitemtype = MyTreeWidget::PropertyItemType::Plot3DAxisValue;
            axis3dxptvar = QVariant::fromValue<void *>(
        ...
        case Graph3DCommon::Plot3DType::Bar: {
            ...
            propertyitemtype =
                    MyTreeWidget::PropertyItemType::Plot3DAxisCatagory;
            axis3dxptvar = QVariant::fromValue<void *>(
        ...
        // canvas
        {
            ...
            canvasitem->setData(
                    0, Qt::UserRole,
                    static_cast<int>(
                            MyTreeWidget::PropertyItemType::Plot3DCanvas));
            switch (plottype) {
            case Graph3DCommon::Plot3DType::Surface:
                plot3dptcanvas = QVariant::fromValue<void *>(
                        static_cast<QAbstract3DGraph *>(
        ...
        // theme
        {
            ...
            QTreeWidgetItem *themeitem =
                    new QTreeWidgetItem(static_cast<QTreeWidget *>(nullptr),
                                        QStringList(themeitemtext));
            themeitem->setToolTip(0, themeitemtext);
            themeitem->setIcon(0,
                               IconLoader::load("theme", IconLoader::General));
            themeitem->setData(
                    0, Qt::UserRole,
                    static_cast<int>(
                            MyTreeWidget::PropertyItemType::Plot3DTheme));
        ...
        // Axis X
        {
            QTreeWidgetItem *axisxitem =
                    new QTreeWidgetItem(static_cast<QTreeWidget *>(nullptr),
                                        QStringList(axisxitemtext));
            axisxitem->setToolTip(0, axisxitemtext);
            axisxitem->setIcon(0,
                               IconLoader::load("graph2d-axis-bottom",
                                                IconLoader::LightDark));
            axisxitem->setData(0, Qt::UserRole,
                               static_cast<int>(propertyitemtype));
        ...
        // Axis Y
        {
            QTreeWidgetItem *axisyitem =
                    new QTreeWidgetItem(static_cast<QTreeWidget *>(nullptr),
                                        QStringList(axisyitemtext));
            axisyitem->setToolTip(0, axisyitemtext);
            axisyitem->setIcon(0,
                               IconLoader::load("graph2d-axis-left",
                                                IconLoader::LightDark));
            axisyitem->setData(0, Qt::UserRole,
                               static_cast<int>(propertyitemtype));
        ...
        // Axis Z
        {
            ...
            QTreeWidgetItem *axiszitem =
                    new QTreeWidgetItem(static_cast<QTreeWidget *>(nullptr),
                                        QStringList(axiszitemtext));
            ...
            axiszitem->setData(
                    0, Qt::UserRole,
                    static_cast<int>(
                            MyTreeWidget::PropertyItemType::Plot3DAxisValue));
        ...
        case Graph3DCommon::Plot3DType::Surface: {
            ...
            plot3ditem->setData(
                    0, Qt::UserRole,
                    static_cast<int>(
                            MyTreeWidget::PropertyItemType::Plot3DSurface));
        } break;
        case Graph3DCommon::Plot3DType::Bar: {
            ...
            plot3ditem->setData(
                    0, Qt::UserRole,
                    static_cast<int>(
                            MyTreeWidget::PropertyItemType::Plot3DBar));
        } break;
        case Graph3DCommon::Plot3DType::Scatter: {
            ...
            plot3ditem->setData(
                    0, Qt::UserRole,
                    static_cast<int>(
                            MyTreeWidget::PropertyItemType::Plot3DScatter));
        } break;
        }
        ...
        // 3D series
        {
            ...
            case Graph3DCommon::Plot3DType::Surface: {
                ...
                foreach (DataBlockSurface3D *block,
                    ...
                    (block->ismatrix())
                            ...
                            : surfaceseriesitemtext =
                                      tr("function %1").arg(count++);
                    QTreeWidgetItem *surfaceseriesitem = new QTreeWidgetItem(
                            static_cast<QTreeWidget *>(nullptr));
                    surfaceseriesitem->setIcon(
                            0,
                            IconLoader::load("graph3d-polygon-mesh",
                                             IconLoader::LightDark));
                    surfaceseriesitem->setData(
                            0, Qt::UserRole,
                            static_cast<int>(MyTreeWidget::PropertyItemType::
                                                     Plot3DSurfaceDataBlock));
            ...
            case Graph3DCommon::Plot3DType::Bar: {
                foreach (DataBlockBar3D *block,
                         lout->getBar3DModifier()->getData()) {
                    ...
                    QTreeWidgetItem *barseriesitem = new QTreeWidgetItem(
                            static_cast<QTreeWidget *>(nullptr));
                    barseriesitem->setIcon(
                            0,
                            IconLoader::load("graph3d-bar",
                                             IconLoader::LightDark));
                    ...
                    (block->ismatrix())
                            ...
                            : scatterseriesitemtext =
                                      tr("%1_%2")
                                              .arg(block->gettable()->name())
                                              .arg(block->getzcolumn()->name());
                    QTreeWidgetItem *scatterseriesitem = new QTreeWidgetItem(
                            static_cast<QTreeWidget *>(nullptr));
                    scatterseriesitem->setIcon(
                            0,
                            IconLoader::load("graph3d-point-mesh",
                                             IconLoader::LightDark));
                    scatterseriesitem->setData(
                            0, Qt::UserRole,
                            static_cast<int>(MyTreeWidget::PropertyItemType::
                                                     Plot3DScatterDataBlock));
        ...
        // table window
        {
            ...
            QTreeWidgetItem *tableitem =
                    new QTreeWidgetItem(static_cast<QTreeWidget *>(nullptr),
                                        QStringList(tableitemtext));
            tableitem->setToolTip(0, tableitemtext);
            tableitem->setIcon(
                    0, IconLoader::load("goto-cell", IconLoader::LightDark));
            tableitem->setData(
                    0, Qt::UserRole,
                    static_cast<int>(
                            MyTreeWidget::PropertyItemType::TableWindow));
        ...
        // matrix window
        {
            ...
            QTreeWidgetItem *matrixitem =
                    new QTreeWidgetItem(static_cast<QTreeWidget *>(nullptr),
                                        QStringList(matrixitemtext));
...
void PropertyEditor::axisrectConnections(AxisRect2D *axisrect)
{
    ...
    connect(axisrect, &AxisRect2D::ImageItem2DMoved, [=]() {
        if (objectbrowser_->currentItem()
            ...
            ImageItem2D *imageitem = getgraph2dobject<ImageItem2D>(
                    objectbrowser_->currentItem());
            if (axisrect == imageitem->getaxisrect()) {
                QPointF origin =
                        imageitem->position("topLeft")->pixelPosition();
...
void PropertyEditor::setObjectPropertyId()
{
    ...
    axispropertylabelpaddingitem_->setPropertyId(
            "axispropertylabelpaddingitem_");
    // Axis Properties Ticks sub block
    ...
    axispropertyticklengthinitem_->setPropertyId(
            "axispropertyticklengthinitem_");
    ...
    itempropertytextbackgroundcoloritem_->setPropertyId(
            "itempropertytextbackgroundcoloritem_");
    itempropertytextrotationitem_->setPropertyId(
            "itempropertytextrotationitem_");
    ...
    // LineSpecialChannel Properties block
    channelplotpropertyxaxisitem_->setPropertyId(
            "channelplotpropertyxaxisitem_");
    channelplotpropertyyaxisitem_->setPropertyId(
            "channelplotpropertyyaxisitem_");
    ...
    cplotpropertyscatterantialiaseditem_->setPropertyId(
            "cplotpropertyscatterantialiaseditem_");
    cplotpropertylegendtextitem_->setPropertyId(
            "cplotpropertylelegendtextitem_");
    ...
    barplotpropertyfillantialiaseditem_->setPropertyId(
            "barplotpropertyfillantialiaseditem_");
    barplotpropertyfillcoloritem_->setPropertyId(
            "barplotpropertyfillcoloritem_");
    ...
    barplotpropertyhistbeginitem_->setPropertyId(
            "barplotpropertyhistbeginitem_");
    barplotpropertyhistenditem_->setPropertyId("barplotpropertyhistenditem_");

    // StatBox Properties block
    statboxplotpropertyxaxisitem_->setPropertyId(
            "statboxplotpropertyxaxisitem_");
    statboxplotpropertyyaxisitem_->setPropertyId(
            "statboxplotpropertyyaxisitem_");
    statboxplotpropertywidthitem_->setPropertyId(
            "statboxplotpropertywidthitem_");
    ...
    vectorpropertylineantialiaseditem_->setPropertyId(
            "vectorpropertylineantialiaseditem_");
    vectorpropertylegendtextitem_->setPropertyId(
            "vectorpropertylegendtextitem_");
    ...
    colormappropertylevelcountitem_->setPropertyId(
            "colormappropertylevelcountitem_");
    colormappropertygradientitem_->setPropertyId(
            "colormappropertygradientitem_");
    ...
    errorbarpropertywhiskerwidthitem_->setPropertyId(
            "errorbarpropertywhiskerwidthitem_");
    errorbarpropertysymbolgaptem_->setPropertyId(
            "errorbarpropertysymbolgaptem_");
    ...
    plot3dvalueaxistickcountitem_->setPropertyId(
            "plot3dvalueaxistickcountitem_");
    ...
    plot3daxisvaluetitlefixeditem_->setPropertyId(
            "plot3daxisvaluetitlefixeditem_");
    plot3daxisvaluetitletextitem_->setPropertyId(
            "plot3daxisvaluetitletextitem_");
    ...
    plot3dsurfacefliphorizontalgriditem_->setPropertyId(
            "plot3dsurfacefliphorizontalgriditem_");
    plot3dsurfaceaspectratioitem_->setPropertyId(
            "plot3dsurfaceaspectratioitem_");
    ...
    plot3dscatterorthoprojectionstatusitem_->setPropertyId(
            "plot3dscatterorthoprojectionstatusitem_");
    plot3dscatterpolarstatusitem_->setPropertyId(
            "plot3dscatterpolarstatusitem_");
    // Plot3D Surface Series
    ...
    plot3dbarseriesbasecoloritem_->setPropertyId(
            "plot3dbarseriesbasecoloritem_");
