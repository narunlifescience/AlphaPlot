...
AxisRect2D *Axis2D::getaxisrect_axis() const
{
    return axisrect_;
}

bool Axis2D::getshowhide_axis() const
{
    return realVisibility();
}

int Axis2D::getoffset_axis() const
{
    return offset();
}

double Axis2D::getfrom_axis() const
{
    return range().lower;
}

double Axis2D::getto_axis() const
{
    return range().upper;
}
...
Axis2D::TickerType Axis2D::gettickertype_axis() const
{
    return tickertype_;
}

bool Axis2D::getinverted_axis() const
{
    return rangeReversed();
}

QColor Axis2D::getstrokecolor_axis() const
{
    return basePen().color();
}

double Axis2D::getstrokethickness_axis() const
{
    return basePen().widthF();
}

Qt::PenStyle Axis2D::getstroketype_axis() const
{
    return basePen().style();
}

bool Axis2D::getantialiased_axis() const
{
    return antialiased();
}

QString Axis2D::getlabeltext_axis() const
{
    return label();
}

QColor Axis2D::getlabelcolor_axis() const
{
    return labelColor();
}

QFont Axis2D::getlabelfont_axis() const
{
    return labelFont();
}

int Axis2D::getlabelpadding_axis() const
{
    return labelPadding();
}

bool Axis2D::gettickvisibility_axis() const
{
    return ticks();
}

int Axis2D::getticklengthin_axis() const
{
    return tickLengthIn();
}

int Axis2D::getticklengthout_axis() const
{
    return tickLengthOut();
}

QColor Axis2D::gettickstrokecolor_axis() const
{
    return tickPen().color();
}
...
int Axis2D::gettickscount_axis() const
{
    return ticker_->tickCount();
}

double Axis2D::getticksorigin() const
{
    return ticker_->tickOrigin();
}

bool Axis2D::getsubtickvisibility_axis() const
{
    return subTicks();
}

int Axis2D::getsubticklengthin_axis() const
{
    return subTickLengthIn();
}

int Axis2D::getsubticklengthout_axis() const
{
    return subTickLengthOut();
}
...
bool Axis2D::getticklabelvisibility_axis() const
{
    return tickLabels();
}

int Axis2D::getticklabelpadding_axis() const
{
    return tickLabelPadding();
}

QFont Axis2D::getticklabelfont_axis() const
{
    return tickLabelFont();
}

QColor Axis2D::getticklabelcolor_axis() const
{
    return tickLabelColor();
}

double Axis2D::getticklabelrotation_axis() const
{
...
int Axis2D::getticklabelprecision_axis() const
{
    return numberPrecision();
}

QSharedPointer<QCPAxisTicker> Axis2D::getticker_axis()
{
    return ticker_;
}

void Axis2D::setshowhide_axis(const bool value)
{
    setVisible(value);
}

void Axis2D::setoffset_axis(const int value)
{
    setOffset(value);
}

void Axis2D::setfrom_axis(const double value)
{
    setRangeLower(value);
}

void Axis2D::setto_axis(const double value)
{
    setRangeUpper(value);
}
...
void Axis2D::setinverted_axis(const bool value)
{
    setRangeReversed(value);
}
...
void Axis2D::setantialiased_axis(const bool value)
{
    setAntialiased(value);
}

void Axis2D::setlabeltext_axis(const QString value)
{
    setLabel(value);
}

void Axis2D::setlabelcolor_axis(const QColor &color)
{
    setLabelColor(color);
}

void Axis2D::setlabelfont_axis(const QFont &font)
{
    setLabelFont(font);
}

void Axis2D::setlabelpadding_axis(const int value)
{
    setLabelPadding(value);
}

void Axis2D::settickvisibility_axis(const bool value)
{
    setTicks(value);
}

void Axis2D::setticklengthin_axis(const int value)
{
    setTickLengthIn(value);
}

void Axis2D::setticklengthout_axis(const int value)
{
    setTickLengthOut(value);
}
...
void Axis2D::setsubtickvisibility_axis(const bool value)
{
    setSubTicks(value);
}
...
void Axis2D::setticklabelformat_axis(const Axis2D::AxisLabelFormat &axisformat)
{
    switch (axisformat) {
...
void Axis2D::save(XmlStreamWriter *xmlwriter)
{
    ...
    case Axis2D::TickerType::Text: {
        ...
        for (int i = 0; i < tickertext_->count(); i++) {
            ...
            xmlwriter->writeAttribute(
                    "value", Utilities::joinstring(tickertext_->at(i)));
    ...
    xmlwriter->writeAttribute("padding",
                              QString::number(getlabelpadding_axis()));
...
bool Axis2D::load(XmlStreamReader *xmlreader)
{
    if (xmlreader->isStartElement() && xmlreader->name() == "axis") {
        ...
        if (ok) {
            (scaletype == "linear") ? setscaletype_axis(AxisScaleType::Linear)
                            ...
                            : xmlreader->raiseWarning(tr(
                                    "Axis2D Scaletype property setting error"));
        } else
            xmlreader->raiseWarning(
        ...
        // upperending
        QString upperending =
                xmlreader->readAttributeString("upperending", &ok);
        if (ok) {
            if (upperending == "none")
                ...
                xmlreader->raiseWarning(
                        tr("Axis2D unknown upper ending property"));
        } else
            xmlreader->raiseWarning(
                    tr("Axis2D upper ending property setting error"));

        // lowerending
        QString lowerending =
                xmlreader->readAttributeString("lowerending", &ok);
        if (ok) {
            if (lowerending == "none")
                ...
                xmlreader->raiseWarning(
                        tr("Axis2D unknown lower ending property"));
        } else
            xmlreader->raiseWarning(
                    tr("Axis2D lower ending property setting error"));

        // inverted property
        bool inverted = xmlreader->readAttributeBool("inverted", &ok);
        (ok) ? setinverted_axis(inverted)
             : xmlreader->raiseWarning(
                     tr("Axis2D inverted property setting error"));
        // antialias property
        ...
        if (ok)
            ...
            xmlreader->raiseWarning(
                    tr("Axis2D antialias property setting error"));
        while (!xmlreader->atEnd()) {
            ...
            if (xmlreader->isStartElement() && xmlreader->name() == "pen") {
                ...
                if (ok)
                    ...
                    xmlreader->raiseWarning(
                            tr("Axis2D pen property setting error"));
            }
        }
        // Loop through sub elements
        while (!xmlreader->atEnd()) {
            if (xmlreader->isEndElement() && xmlreader->name() == "axis")
                break;
            // ticker
                    ...
                    if (tkrtype == "text") {
                        while (!xmlreader->atEnd()) {
                            if (xmlreader->isEndElement()
                                && xmlreader->name() == "ticker")
                                break;

                            if (xmlreader->isStartElement()
                                && xmlreader->name() == "tick") {
                                QString tkrtext =
                                        xmlreader->readAttributeString("value",
                                                                       &ok);
                                (ok) ? tickertext_->append(tkrtext)
                                     : xmlreader->raiseWarning(tr(
                                             "Axis2D tickertype text element "
                        ...
                        QString format =
                                xmlreader->readAttributeString("format", &ok);
                        (ok) ? ticker_.staticCast<QCPAxisTickerDateTime>()
                                        ->setDateTimeFormat(
                                                Utilities::splitstring(format))
                             : xmlreader->raiseWarning(
                                     tr("Axis2D tickertype datetime "
                                        "formatproperty setting error"));
                    }
                } else
                    xmlreader->raiseWarning(
            ...
            if (xmlreader->isStartElement() && xmlreader->name() == "label") {
                ...
                if (ok)
                    ...
                    xmlreader->raiseWarning(
                            tr("Axis2D label property setting error"));
                // Label padding
                ...
                if (ok)
                    ...
                    xmlreader->raiseWarning(
                            tr("Axis2D padding property setting error"));
                while (!xmlreader->atEnd()) {
                    xmlreader->readNext();
                    if (xmlreader->isEndElement()
                    ...
                    if (xmlreader->isStartElement()
                        && xmlreader->name() == "font") {
                        QPair<QFont, QColor> fontpair =
                                xmlreader->readFont(&ok);
                        if (ok) {
                            setlabelfont_axis(fontpair.first);
                            setlabelcolor_axis(fontpair.second);
                        } else
                            xmlreader->raiseWarning(
                                    tr("Axis2D font & color property setting "
                                       "error"));
                    }
                }
            }
            ...
            if (xmlreader->isStartElement() && xmlreader->name() == "ticks") {
                ...
                (ok) ? setticksorigin(origin)
                     : xmlreader->raiseWarning(tr(
                             "Axis2D Tick origin in property setting error"));
                // Ticks in
                ...
                if (ok)
                    ...
                    xmlreader->raiseWarning(tr(
                            "Axis2D Tick Length out property setting error"));
                while (!xmlreader->atEnd()) {
                    xmlreader->readNext();
                    if (xmlreader->isEndElement()
                        && xmlreader->name() == "ticks")
                        break;
                    if (xmlreader->isStartElement()
                        && xmlreader->name() == "pen") {
                        ...
                        if (ok) {
                            ...
                            xmlreader->raiseWarning(tr(
                                    "Axis2D tick pen property setting error"));
                    }
                }
            }
            // Sub Ticks element
            if (xmlreader->isStartElement()
                && xmlreader->name() == "subticks") {
                // visible property
                bool subtickvisible =
                        xmlreader->readAttributeBool("visible", &ok);
                if (ok)
                    setsubtickvisibility_axis(subtickvisible);
                else
                    xmlreader->raiseWarning(tr(
                            "Axis2D subtick visible property setting error"));
                // Ticks in
                int in = xmlreader->readAttributeInt("in", &ok);
                if (ok)
                    ...
                    xmlreader->raiseWarning(tr(
                            "Axis2D subTick length in property setting error"));
                // out length
                int out = xmlreader->readAttributeInt("out", &ok);
                if (ok)
                    setsubticklengthout_axis(out);
                else
                    xmlreader->raiseWarning(tr("Axis2D subTick Length out "
                ...
                while (!xmlreader->atEnd()) {
                    ...
                    if (xmlreader->isStartElement()
                        ...
                        if (ok) {
                            ...
                            xmlreader->raiseWarning(
                                    tr("Axis2D subtick pen property setting "
                                       "error"));
                    }
                }
            }
            ...
            if (xmlreader->isStartElement()
                ...
                if (ok)
                    ...
                    xmlreader->raiseWarning(tr("Axis2D tick label visible "
                                               "property setting error"));
                // Tick label padding
                int ticklabelpadding =
                        xmlreader->readAttributeInt("padding", &ok);
                if (ok)
                    setticklabelpadding_axis(ticklabelpadding);
                else
                    xmlreader->raiseWarning(tr("Axis2D tick label padding in "
                                               "property setting error"));
                // Tick Label Rotation
                ...
                if (ok)
                    ...
                    xmlreader->raiseWarning(tr("Axis2D tick label rotation "
                                               "property setting error"));
                // Tick label side
                QString ticklabelside =
                        xmlreader->readAttributeString("side", &ok);
                if (ok)
                    if (ticklabelside == "up")
                        ...
                        xmlreader->raiseWarning(tr("Axis2D tick label side "
                                                   "property setting error"));
                else
                    xmlreader->raiseWarning(tr(
                            "Axis2D tick label side property setting error"));
                // tick label format
                QString ticklabelformat =
                        xmlreader->readAttributeString("format", &ok);
                if (ok)
                    if (ticklabelformat == "E")
                        ...
                        xmlreader->raiseWarning(tr("Axis2D tick label format "
                                                   "property setting error"));
                else
                    xmlreader->raiseWarning(tr(
                            "Axis2D tick label format property setting error"));
                // Tick label precision
                int ticklabelprecision =
                        xmlreader->readAttributeInt("precision", &ok);
                if (ok)
                    setticklabelprecision_axis(ticklabelprecision);
                else
                    xmlreader->raiseWarning(tr("Axis2D tick label precision "
                                               "property setting error"));
                while (!xmlreader->atEnd()) {
                    xmlreader->readNext();
                    if (xmlreader->isEndElement()
...
void Axis2D::clone(Axis2D *axis)
{
    ...
    for (int i = 0; i < axis->tickertext_->count(); i++) {
        textticker->addTick(i,
                            Utilities::splitstring(axis->tickertext_->at(i)));
    }
