...
Axis2D *Vector2D::getxaxis()
{
    return xaxis_;
}

Axis2D *Vector2D::getyaxis()
{
    return yaxis_;
}
...
Vector2D::LineEnd
Vector2D::getendstyle_vecplot(const Vector2D::LineEndLocation &location) const
{
...
double
Vector2D::getendwidth_vecplot(const Vector2D::LineEndLocation &location) const
{
    QCPLineEnding *ending;
    switch (location) {
    case LineEndLocation::Start:
...
double
Vector2D::getendheight_vecplot(const Vector2D::LineEndLocation &location) const
{
    QCPLineEnding *ending;
    switch (location) {
    case LineEndLocation::Start:
...
QString Vector2D::getlegendtext_vecplot() const
{
    return name();
}
...
void Vector2D::setendinverted_vecplot(const bool value,
                                      const Vector2D::LineEndLocation &location)
{
    QCPLineEnding *ending {};
    switch (location) {
...
void Vector2D::setlegendtext_vecplot(const QString &name)
{
    setName(name);
}
...
void Vector2D::save(XmlStreamWriter *xmlwriter, int xaxis, int yaxis)
{
    ...
    (vectorplot_ == VectorPlot::XYAM)
            ? xmlwriter->writeAttribute("type", "xyam")
    ...
    xmlwriter->writeAttribute("endwidth",
                              QString::number(getendwidth_vecplot(
                                      Vector2D::LineEndLocation::Stop)));
    xmlwriter->writeAttribute("endheight",
                              QString::number(getendheight_vecplot(
                                      Vector2D::LineEndLocation::Stop)));
    QPen p;
