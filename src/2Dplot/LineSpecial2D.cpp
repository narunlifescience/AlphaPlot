...
LineSpecial2D::LineSpecial2D(Table *table, Column *xcol, Column *ycol, int from,
    ...
    : QCPGraph(xAxis, yAxis),
      ...
      xerrorbar_(nullptr),
      yerrorbar_(nullptr),
      layername_(QString("<LineSpecial2D>")
...
bool LineSpecial2D::getlineantialiased_lsplot() const
{
    return antialiased();
}
...
QString LineSpecial2D::getlegendtext_lsplot() const
{
    return name();
}

Axis2D *LineSpecial2D::getxaxis() const
{
    return xAxis_;
}

Axis2D *LineSpecial2D::getyaxis() const
{
    return yAxis_;
}

void LineSpecial2D::setlinetype_lsplot(const Graph2DCommon::LineStyleType &line)
{
    switch (line) {
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement() && xmlreader->name() == "pen") {
                    ...
                    if (ok) {
                        ...
                        xmlreader->raiseWarning(tr("LineSpecial2D line pen "
                                                   "property setting error"));
                }
            }
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement()
                    ...
                    if (ok) {
                        ...
                        xmlreader->raiseWarning(tr("LineSpecial2D linebrush "
                                                   "property setting error"));
                }
            }
        }
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement() && xmlreader->name() == "pen") {
                    ...
                    if (ok) {
                        ...
                        xmlreader->raiseWarning(tr("LineSpecial2D scatter pen "
                                                   "property setting error"));
                }
            }
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement()
                    ...
                    if (ok) {
                        ...
                        xmlreader->raiseWarning(tr("LineSpecial2D scatterbrush "
                                                   "property setting error"));
                }
            }
        }
...
void LineSpecial2D::mousePressEvent(QMouseEvent *event, const QVariant &details)
{
