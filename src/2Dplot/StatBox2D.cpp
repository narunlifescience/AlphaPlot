...
Axis2D *StatBox2D::getxaxis() const
{
    return xAxis_;
}

Axis2D *StatBox2D::getyaxis() const
{
    return yAxis_;
}
...
QColor StatBox2D::getfillcolor_statbox() const
{
    return brush().color();
}
...
void StatBox2D::setboxstyle_statbox(const StatBox2D::BoxWhiskerStyle &boxStyle)
{
    switch (boxStyle) {
    case SD:
...
bool StatBox2D::load(XmlStreamReader *xmlreader)
{
    ...
    while (!xmlreader->atEnd()) {
        if (xmlreader->isEndElement() && xmlreader->name() == "statbox")
            break;
        ...
        if (xmlreader->isStartElement() && xmlreader->name() == "box") {
            ...
            (ok) ? setfillstatus_statbox(fill)
                 : xmlreader->raiseWarning(tr(
                         "StatBox2D box fill status property setting error"));
            ...
            (ok) ? setAntialiasedFill(boxantialiasfill)
                 : xmlreader->raiseWarning(tr("StatBox2D box antialias "
                                              "propfill erty setting error"));
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement() && xmlreader->name() == "pen") {
                    ...
                    (ok) ? setPen(boxpen)
                         : xmlreader->raiseWarning(tr(
                                 "StatBox2D box pen property setting error"));
                }
            }
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement()
                    ...
                    (ok) ? setBrush(boxbrush)
                         : xmlreader->raiseWarning(tr(
                                 "Curve2D linebrush property setting error"));
                }
            }
        }
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement() && xmlreader->name() == "pen") {
                    ...
                    (ok) ? setMedianPen(mpen)
                         : xmlreader->raiseWarning(
                                 tr("StatBox2D median pen property setting "
                                    "error"));
                }
            }
        }
        ...
        if (xmlreader->isStartElement() && xmlreader->name() == "whisker") {
            ...
            (ok) ? setWhiskerAntialiased(boxantialias)
                 : xmlreader->raiseWarning(tr(
                         "StatBox2D whisker antialias property setting error"));
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement() && xmlreader->name() == "pen") {
                    ...
                    (ok) ? setWhiskerPen(wpen)
                         : xmlreader->raiseWarning(
                                 tr("StatBox2D whisker pen property setting "
                                    "error"));
                }
            }
        }
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement() && xmlreader->name() == "pen") {
                    ...
                    (ok) ? setWhiskerBarPen(wbpen)
                         : xmlreader->raiseWarning(
                                 tr("StatBox2D whiskerbar pen property setting "
                                    "error"));
                }
            }
        }
        ...
        if (xmlreader->isStartElement() && xmlreader->name() == "scatter") {
            ...
            if (ok) {
                if (scattershape == "dot") {
                    ...
                    setscattershape_statbox(
                            Graph2DCommon::ScatterStyle::Circle);
                } else if (scattershape == "square") {
                    setscattershape_statbox(
                            Graph2DCommon::ScatterStyle::Square);
            ...
            (ok) ? setAntialiasedScatters(scatterantialias)
                 : xmlreader->raiseWarning(tr("ScatterBox2D scatter antialias "
            ...
            while (!xmlreader->atEnd()) {
                ...
                if (xmlreader->isStartElement() && xmlreader->name() == "pen") {
                    ...
                    if (ok) {
                        ...
                        xmlreader->raiseWarning(tr("ScatterBox2D scatter pen "
                                                   "property setting error"));
                }
            }
        }
