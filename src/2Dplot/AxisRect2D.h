...
class AxisRect2D : public QCPAxisRect
{
    Q_OBJECT
private:
    typedef QPair<QPair<Grid2D *, Axis2D *>, QPair<Grid2D *, Axis2D *>>
            GridPair;
...
public:
    ...
    QPair<LineSpecial2D *, LineSpecial2D *>
    addLineSpecialChannel2DPlot(Table *table, Column *xData, Column *yData1,
                                Column *yData2, int from, int to, Axis2D *xAxis,
                                Axis2D *yAxis);
    Curve2D *addCurve2DPlot(const AxisRect2D::LineScatterType &type,
    ...
    QList<Axis2D *>
    getAxesOrientedTo(const Axis2D::AxisOreantation &orientation) const;
