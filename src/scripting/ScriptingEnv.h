...
public:
    ...
    //! Part of the initialization is deferred from the constructor until after
    //! the signals have been connected.
    virtual bool initialize() { return true; }
    //! initialization of the interpreter may fail; or there could be other errors
    //! setting up the environment
    bool initialized() const { return d_initialized; }
    //! whether asynchronuous execution is enabled (if supported by the
    //! implementation)
    ...
    //    virtual QSyntaxHighlighter syntaxHighlighter(QTextEdit *textEdit)
    //    const;
