      ...
      scriptingSettingsModel_(new QStandardItemModel(this))
{
    ...
    // Prepare scrollarea.
    QString scrollbackcol = "QScrollArea {background-color : "
    ...
    // Prepare label.
    QString label_font_color = "QLabel {color : rgba(%1,%2,%3,%4);"
                               " padding-left: 10px;"
                               " padding-right: 10px;"
                               " padding-top: 10px;"
                               " padding-bottom: 10px}";
    ...
    addPage(General, Page_GeneralApplication,
            new ApplicationSettingsPage(this));
    addPage(General, Page_GeneralConfirmation,
            new ApplicationSettingsPage(this));
    addPage(General, Page_GeneralAppearance,
    ...
    QStandardItem *item3 = new QStandardItem(
            QIcon(":/data/drive-removable-media-usb-pendrive.png"),
            "Removable Drive");
    QStandardItem *item4 =
            new QStandardItem(QIcon(":/data/download.png"), "Download");
    QStandardItem *item5 = new QStandardItem(QIcon(":/data/ipodtouchicon.png"),
                                             "Ipod Touch Device");
        ...
        aSettingsListView *&listView)
{
    if (listView->model()->rowCount() > 0) {
        listView->setFixedHeight(((((listView->model()->rowCount()
