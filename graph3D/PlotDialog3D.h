 ...
 *                                                                         *
 ***************************************************************************/
#ifndef PLOT_DIALOG_3D_H
#define PLOT_DIALOG_3D_H
...
class PlotDialog3D : public QDialog
{ 
    Q_OBJECT

public:
    PlotDialog3D( QWidget* parent = 0, Qt::WFlags fl = 0 );
    ~PlotDialog3D();
