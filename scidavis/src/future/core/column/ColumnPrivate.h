...
class Column::Private {
 public:
  ...
  Private(Column* owner, SciDAVis::ColumnDataType type,
          SciDAVis::ColumnMode mode, void* data,
   ...
   */
  void replaceModeData(SciDAVis::ColumnMode mode, SciDAVis::ColumnDataType type,
