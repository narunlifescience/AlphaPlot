...
void Column::initPrivate(std::unique_ptr<QVector<qreal> > d,
  ...
  d_column_private = new Private(this, SciDAVis::TypeDouble, SciDAVis::Numeric,
                                 d.release(), v);
}
...
void Column::initPrivate(std::unique_ptr<QStringList> d,
                         IntervalAttribute<bool> v) {
  d_column_private =
      new Private(this, SciDAVis::TypeQString, SciDAVis::Text, d.release(), v);
}
...
void Column::save(QXmlStreamWriter* writer) const {
  ...
  writer->writeAttribute(
      "type", SciDAVis::enumValueToString(dataType(), "ColumnDataType"));
  writer->writeAttribute(
      "mode", SciDAVis::enumValueToString(columnMode(), "ColumnMode"));
  writer->writeAttribute(
      "plot_designation",
