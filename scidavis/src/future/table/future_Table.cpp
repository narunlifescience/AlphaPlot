...
void Table::setSelectedColumnsAsX() { setSelectionAs(SciDAVis::X); }

void Table::setSelectedColumnsAsY() { setSelectionAs(SciDAVis::Y); }

void Table::setSelectedColumnsAsZ() { setSelectionAs(SciDAVis::Z); }

void Table::setSelectedColumnsAsYError() { setSelectionAs(SciDAVis::yErr); }

void Table::setSelectedColumnsAsXError() { setSelectionAs(SciDAVis::xErr); }
...
int Table::colX(int col) {
  for (int i = col - 1; i >= 0; i--) {
    if (column(i)->plotDesignation() == SciDAVis::X) return i;
  }
  int cols = columnCount();
...
int Table::colY(int col) {
  ...
  if (column(col)->plotDesignation() == SciDAVis::xErr ||
    ...
    for (int i = col - 1; i >= 0; i--) {
      if (column(i)->plotDesignation() == SciDAVis::Y) return i;
    }
    for (int i = col + 1; i < cols; i++) {
      if (column(i)->plotDesignation() == SciDAVis::Y) return i;
    }
