 ...
 * Add a QwtPlotItem subclass (PlotEnrichment ?) and make PlotEnrichement,
 * Legend and ArrowMarker
...
class PlotEnrichement : public QwtPlotMarker {
 public:
  ...
  virtual void setBoundingRect(double left, double top, double right,
                               double bottom);
