 ...
 *                                                                         *
 ***************************************************************************/
#ifndef FUNCTION_DIALOG_3D_H
#define FUNCTION_DIALOG_3D_H
...
class FunctionDialog3D : public QDialog
{
    Q_OBJECT

public:
    FunctionDialog3D( QWidget* parent = 0, Qt::WFlags fl = 0 );
    ~FunctionDialog3D();
...
#endif // ifndef FUNCTION_DIALOG_3D_H
