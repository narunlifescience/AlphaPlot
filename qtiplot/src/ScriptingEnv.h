/***************************************************************************
    File                 : CHECKMEScriptingEnv.h Script.h
    Project              : QtiPlot
    --------------------------------------------------------------------
...
class CHECKMEScriptingEnv.h Script.hangeEvent : public QEvent
{
  public:
    CHECKMEScriptingEnv.h Script.hangeEvent(ScriptingEnv *e) : QEvent(SCRIPTING_CHANGE_EVENT), env(e) {}
...
//! Interface for maintaining a reference to the current ScriptingEnv
   ...
   * CHECKMEScriptingEnv.h Script.hangeEvents to scripted::scriptingChangeEvent.
   */
class scripted
{
  public:
   ...
   ~scripted();
   void scriptingChangeEvent(CHECKMEScriptingEnv.h Script.hangeEvent*);
  protected:
