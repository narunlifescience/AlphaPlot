...
void Grid::load(const QStringList &grid) {
  ...
  if (grid.count() == 21) {  // since 0.9 final
    majPenX = QPen(QColor(grid[5]), grid[7].toInt(),
                   Graph::getPenStyle(grid[6].toInt()));
    minPenX = QPen(QColor(grid[8]), grid[10].toInt(),
                   Graph::getPenStyle(grid[9].toInt()));
    majPenY = QPen(QColor(grid[11]), grid[13].toInt(),
                   Graph::getPenStyle(grid[12].toInt()));
    minPenY = QPen(QColor(grid[14]), grid[16].toInt(),
    ...
    majPenX = QPen(ColorBox::color(grid[5].toInt()), grid[7].toInt(),
                   Graph::getPenStyle(grid[6].toInt()));
    minPenX = QPen(ColorBox::color(grid[8].toInt()), grid[10].toInt(),
                   Graph::getPenStyle(grid[9].toInt()));
    majPenY = majPenX;
    minPenY = minPenX;
