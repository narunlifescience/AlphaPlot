...
extern "C" MY_EXPORT const char *name() { return "Rational0"; }

extern "C" MY_EXPORT const char *function() { return "(b + c*x)/(1 + a*x)"; }

extern "C" MY_EXPORT const char *parameters() { return "a,b,c"; }
