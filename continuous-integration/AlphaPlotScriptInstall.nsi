;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;  File                 : AlphaPlotScriptInstall.nsi
;  Project              : AlphaPlot
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
!define PRODUCT_NAME "AlphaPlot"
!define PRODUCT_VERSION "1.D5"
!define PRODUCT_WEB_SITE "http://AlphaPlot.sourceforge.net/"
!define PRODUCT_DIR_REGKEY "Software\Microsoft\Windows\CurrentVersion\App Paths\AlphaPlot.exe"
...
!define MUI_ICON "AlphaPlot.ico"
;!define MUI_UNICON "${NSISDIR}\Contrib\Graphics\Icons\modern-uninstall.ico"
!define MUI_UNICON "AlphaPlot.ico"
...
; Finish page
!define MUI_FINISHPAGE_RUN "$INSTDIR\AlphaPlot.exe"
...
OutFile "AlphaPlot-${PRODUCT_VERSION}-win32-setup.exe"
InstallDir "$PROGRAMFILES\${PRODUCT_NAME}"
InstallDirRegKey HKLM "${PRODUCT_DIR_REGKEY}" ""
ShowInstDetails show
ShowUnInstDetails show

Section "AlphaPlot" SEC01
  SectionIn RO
  SetOutPath "$INSTDIR"
  ...
  File "AlphaPlot.exe"
  File "AlphaPlotrc.py"
  File "AlphaPlotrc.pyc"
  File "AlphaPlotUtil.py"
  ;File "AlphaPlotUtil.pyc"
  File "assistant.exe"
  File "sip.pyd"
  File "python27.dll"
  File "zlib1.dll"
  ...
  File "translations\AlphaPlot_de.qm"
  File "translations\AlphaPlot_es.qm"
  File "translations\AlphaPlot_fr.qm"
  File "translations\AlphaPlot_ja.qm"
  File "translations\AlphaPlot_ru.qm"
  File "translations\AlphaPlot_sv.qm"
  File "translations\AlphaPlot_pt-br.qm"
  File "translations\AlphaPlot_cs.qm"
  File "translations\AlphaPlot_cs-alt.qm"
...
; Shortcuts
  ...
  CreateShortCut "$SMPROGRAMS\$ICONS_GROUP\${PRODUCT_NAME}.lnk" "$INSTDIR\AlphaPlot.exe"
  !insertmacro MUI_STARTMENU_WRITE_END
SectionEnd

Section /o "Desktop shortcut" SEC02
  SectionIn 1
  CreateShortCut "$DESKTOP\${PRODUCT_NAME}.lnk" "$INSTDIR\AlphaPlot.exe"
SectionEnd
...
Section -Post
  ...
  WriteRegStr HKLM "${PRODUCT_DIR_REGKEY}" "" "$INSTDIR\AlphaPlot.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayName" "$(^Name)"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "UninstallString" "$INSTDIR\uninst.exe"
  WriteRegStr ${PRODUCT_UNINST_ROOT_KEY} "${PRODUCT_UNINST_KEY}" "DisplayIcon" "$INSTDIR\AlphaPlot.exe"
...
Section Uninstall
  ...
  Delete "$INSTDIR\AlphaPlotUtil.pyc"
  Delete "$INSTDIR\AlphaPlotUtil.py"
  Delete "$INSTDIR\AlphaPlotrc.pyc"
  Delete "$INSTDIR\AlphaPlotrc.py"
  Delete "$INSTDIR\AlphaPlot.exe"
  Delete "$INSTDIR\AlphaPlot.ico"
  ...
  Delete "$INSTDIR\translations\AlphaPlot_de.qm"
  Delete "$INSTDIR\translations\AlphaPlot_es.qm"
  Delete "$INSTDIR\translations\AlphaPlot_fr.qm"
  Delete "$INSTDIR\translations\AlphaPlot_ja.qm"
  Delete "$INSTDIR\translations\AlphaPlot_ru.qm"
  Delete "$INSTDIR\translations\AlphaPlot_sv.qm"
  Delete "$INSTDIR\translations\AlphaPlot_pt-br.qm"
  Delete "$INSTDIR\translations\AlphaPlot_cs.qm"
  Delete "$INSTDIR\translations\AlphaPlot_cs-alt.qm"
